...
| Marketing Campaign Agent | `agents/marketing_agent/` | Done (Gemini 3.1 Flash Lite + Streamlit + BeautifulSoup) |
| Research Agent | `agents/research_agent/` | Done (Gemini 3.1 Flash Lite + Streamlit + DuckDuckGo + BeautifulSoup) |
| Job Application Agent | `agents/job_application_agent/` | Done (Gemini 3.1 Flash Lite + Streamlit + DuckDuckGo + BeautifulSoup) |
| Data Analyst Agent | `agents/data_analyst_agent/` | Done (Gemini 3.1 Flash Lite + Streamlit + Pandas + Plotly) |
